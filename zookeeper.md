# zookeeper
关键字：简单;可构建集群,分布式;ZNode（分持久、临时）;树结构;读写快,1:10;Leader负责读写,Follow负责读,写有序;Watch(事件监听器);数据存内存,重启可从磁盘恢复;Session会话;版本;ACL权限控制;
Zab协议&Paxos算法
特性：顺序一致性;原子性;单一系统映像;可靠性
高级应用：构建分布式锁、二阶段事务;Lead选举;集中配置等

http://zookeeper.apache.org/doc/r3.4.14/ 
zookeeper官方文档

https://segmentfault.com/a/1190000016349824
 ZooKeeper 概念讲的最清楚的一篇文章

https://yq.aliyun.com/articles/701172?spm=a2c4e.11155472.0.0.11cd1a5brd1vNI
一句话说清分布式锁，进程锁，线程锁

zookeeper、redis等可实现分布式锁 
https://www.cnblogs.com/liuyang0/p/6800538.html zookeeper实现参考
